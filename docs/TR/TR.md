...
7. История:
   - Финансовых операций с счётом
   - Купли-продаж активов
...
![Use-Case Диаграмма](docs/TR/SaD/Use-Case.jpg)
...
![User-flow Схема](docs/TR/SaD/User flow.jpg)

#### 3. Сотрудник
![Employee-flow Схема](docs/TR/SaD/Employee flow.jpg)
